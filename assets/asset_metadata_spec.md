## Satoxcoin Metadata Specification

Additional fields may be added, but will be ignored by Satoxcoin.
...
```
{
   ...
   "contract_signature": "<Satoxcoin signed contract_hash>",
