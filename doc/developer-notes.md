...
The Satoxcoin Doxygen documentation can be generated by running `make docs` from the top-level 
...
Run with the -testnet option to run with "play satoxcoins" on the test network, if you
...
Satoxcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- SatoxcoinMiner : Generates satoxcoin's (if wallet is enabled).
...
However, in open source software such as Satoxcoin Core, where everyone uses
...
Some of these are maintained by active developers of Satoxcoin Core, in which case changes should probably go
directly upstream without being PRed directly against the project.  They will be merged back in the next
subtree merge.

Others are external projects without a tight relationship with our project.  Changes to these should also
be sent upstream but bugfixes may also be prudent to PR against Satoxcoin Core so that they can be integrated
...
- src/libsecp256k1
  - Upstream at https://github.com/satoxcoin-core/secp256k1/ ; actively maintaned by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/satoxcoin-core/ctaes ; actively maintained by Core contributors.
