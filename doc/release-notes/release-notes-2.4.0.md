Satoxcoin Core version *2.4.0* is now available!!
==============
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/satoverse/Satoxcoin/issues>

To receive security and update notifications, please subscribe to:

  <https://satoverse.io/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/Satoxcoin-Qt` (on Mac)
or `satoxcoind`/`satoxcoin-qt` (on Linux).
...
Satoxcoin Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows 10(x64) and later. 32-bit versions of Windows,
and Windows XP are not supported.

Satoxcoin Core should also work on most other Unix-like systems but is not
frequently tested on them.

Satoxcoin Core has been tested with macOS 10.14 Mojave, but it is recommended that *developers*
...
Satoxcoin Core has not been tested with macOS Catalina(beta). Please use at your own risk.
...
Changelog available here: <https://github.com/satoverse/Satoxcoin/commits/release_2.4.0>
...
- Most importantly - The Satoxcoin Community!
