...
class TxnMallTest(SatoxcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 SATOX:
        ...
        # First: use raw transaction API to send 1240 SATOX to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 SATOX coin each
        ...
        # Node0's balance should be starting balance, plus 50SATOX for another
        ...
        # Node0's total balance should be starting balance, plus 100SATOX for 
