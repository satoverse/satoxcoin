...
#ifndef SATOXCOINCOIN_ASSET_PROTOCOL_H
#define SATOXCOINCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_SATOXCOIN_ASSET SATOXQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_SATOXCOIN_ASSET SATOXO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_SATOXCOIN_ASSET SATOXR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_SATOXCOIN_ASSET SATOXT
...
#endif //SATOXCOINCOIN_ASSET_PROTOCOL_H
