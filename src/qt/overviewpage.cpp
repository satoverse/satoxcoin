...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(SatoxcoinUnits::SATOX),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->satoxcoinBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->satoxcoinBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("SATOX")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the SATOX balance grid from expanding and looking terrible when asset balance is hidden
