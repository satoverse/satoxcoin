...
//
//     src/qt/test/test_satoxcoin-qt -platform xcb      # Linux
//     src/qt/test/test_satoxcoin-qt -platform windows  # Windows
//     src/qt/test/test_satoxcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = SatoxcoinUnits::formatWithUnit(unit, balance, false, SatoxcoinUnits::separatorAlways);
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: satoxcoin:")) != -1);
