...
void SatoxcoinGUI::createActions()
{
    ...
    transferAssetAction->setStatusTip(tr("Transfer assets to SATOX addresses"));
...
void SatoxcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        label->setPixmap(QPixmap::fromImage(QImage(":/icons/satoxcoincointext")));
...
//        toolbar->addAction(votingAction);
        ...
        satoxcoinLabelLayout->addWidget(label);
        satoxcoinLabelLayout->addWidget(toolbar);
...
void SatoxcoinGUI::showDebugWindowActivateInformation()
{
...
void SatoxcoinGUI::showDebugWindowPeerList()
{
    rpcConsole->setTabFocus(RPCConsole::TAB_PEERS);
    showDebugWindow();
}

void SatoxcoinGUI::showDebugWindowNetworkTraffic()
{
...
void SatoxcoinGUI::checkAssets()
{
    ...
    if(AreAssetsDeployed()) {
        ...
        transferAssetAction->setToolTip(tr("Transfer assets to SATOX addresses"));
