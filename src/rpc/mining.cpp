...
// NOTE: Unlike wallet RPC (which use SATOX values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
UniValue submitblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2) {
        throw std::runtime_error(
            ...
            "See https://en.satoxcoin.it/wiki/BIP_0022 for full specification.\n"
