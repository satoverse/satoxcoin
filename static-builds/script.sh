...
rm -rf ~/satoxcoincoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../satoxcoincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../satoxcoincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/satoxcoincoin/temp
cd ~/satoxcoincoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/satoxcoincoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/satoxcoincoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
