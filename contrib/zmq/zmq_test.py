...
"""
    ...
    Satoxcoin should be started with the command line arguments:
        satoxcoind -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND SATOX issuance at " + str(pos))
				print("After SATOX: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND SATOX something at " + str(pos))
			start += pos+8
			print(astr)
